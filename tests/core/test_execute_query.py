...
def test_execute_query(pysoni_client_connection_with_envvars):
    ...
    results = pysoni_client_connection_with_envvars.execute_query(queryname = "SELECT 1 AS column1, 2")
...
def test_execute_query_with_types(pysoni_client_connection_with_envvars):
    ...
    results_with_types = pysoni_client_connection_with_envvars.execute_query(queryname = "SELECT 1,2,3",
                            types = True)
